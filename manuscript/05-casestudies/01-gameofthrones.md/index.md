...
```
    ...
    <networkx.classes.graph.Graph at 0x7f5c0bd8d550>
...
```
    ...
    [('Eddard-Stark', 0.07239401100498243),
     ('Robert-Baratheon', 0.048517275705099325),
     ('Jon-Snow', 0.047706890624749115),
     ('Tyrion-Lannister', 0.04367437892706291),
     ('Catelyn-Stark', 0.034667034701307387),
     ('Bran-Stark', 0.029774200539800195),
     ('Robb-Stark', 0.02921618364519685),
     ('Daenerys-Targaryen', 0.02708962251302115),
     ('Sansa-Stark', 0.02696177891568309),
